...
package org.cybergarage.util.xml.parser;
...
public class XercesParser extends org.cybergarage.util.xml.Parser
{
	////////////////////////////////////////////////
	//	Constructor
	////////////////////////////////////////////////
	...
	public org.cybergarage.util.xml.Node parse(org.cybergarage.util.xml.Node parentNode, org.w3c.dom.Node domNode, int rank)
	{
...
//		Debug.message("[" + rank + "] ELEM : " + domNodeName + ", " + domNodeValue + ", type = " + domNodeType + ", attrs = " + arrrsLen);
		...
		org.cybergarage.util.xml.Node node = new org.cybergarage.util.xml.Node();
	...
	public org.cybergarage.util.xml.Node parse(org.cybergarage.util.xml.Node parentNode, org.w3c.dom.Node domNode)
	{
	...
	public org.cybergarage.util.xml.Node parse(InputStream inStream) throws ParserException
	{
		org.cybergarage.util.xml.Node root = null;
